...
@LogstashPlugin(name="ingestnode")
public class IngestNodeFilter implements Filter, PipelineProvider {
    ...
    public IngestNodeFilter(final Configuration configuration, final Context context) throws Exception {
        this(new FileInputStream("/home/dan/dev/lsjava/pipelinedef.json"), "my_pipeline");
    ...
    public Collection<Event> filter(Collection<Event> e) {
        try {
